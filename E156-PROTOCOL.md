# E156 Protocol — `ctgov-geography-scale-visibility`

This repository is the source code and dashboard backing an E156 micro-paper on the [E156 Student Board](https://mahmood726-cyber.github.io/e156/students.html).

---

## `[216]` CT.gov Geography-Scale Visibility

**Type:** methods  |  ESTIMAND: 2-year no-results rate across site-footprint buckets among eligible older CT.gov studies  
...
Links:
  ...
  Protocol:  https://github.com/mahmood726-cyber/ctgov-geography-scale-visibility/blob/main/E156-PROTOCOL.md
  Dashboard: https://mahmood726-cyber.github.io/ctgov-geography-scale-visibility/
